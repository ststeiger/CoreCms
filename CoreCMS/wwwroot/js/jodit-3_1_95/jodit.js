...
}("undefined" != typeof self ? self : this, function ()
{
    ...
    }([function (e, t, o)
    {
        ...
        {
            var n;
            if (!/:scope/.test(e) || !t.isIE() || "undefined" != typeof HTMLDocument && o instanceof HTMLDocument) n = o.querySelectorAll(e);
            else
            {
                var i = o.id,
                    r = i || "_selector_id_" + ("" + Math.random()).slice(2) + l++;
        ...
        }, t.extend = function ()
        {
            ...
            var n, i, r, s, a, l, c, p, f = e[0] || {},
                h = 1,
                m = e.length,
                v = !1;
            for ("boolean" == typeof f && (v = f, f = e[h] || {}, h += 1), "object" != typeof f && "function" === t.type(f) && (f = {}), h === m && (f = this, h += 1), h; m > h; h += 1)
                if (null !== (n = e[h]) && void 0 !== n)
                    for (p = Object.keys(n), c = 0; p.length > c; c += 1) i = p[c], r = f[i], s = n[i], f !== s && (v && s && (t.isPlainObject(s) && !(s instanceof u) || Array.isArray(s) && !(s instanceof d)) ? (a = Array.isArray(s), a ? (a = !1, l = r && Array.isArray(r) ? r : []) : l = r && t.isPlainObject(r) ? r : {}, f[i] = t.extend(v, l, s)) : void 0 !== s && (f[i] = s));
            return f
        }, t.trim = function (e)
        {
        ...
        }, t.convertMediaURLToVideoEmbed = function (e, o, n)
        {
            ...
            switch (i.href = e, o || (o = 400), n || (n = 345), i.hostname)
            {
                ...
                case "youtu.be":
                case "www.youtu.be":
                    var s = i.search ? t.parseQuery(i.search) : {
        ...
        {
            void 0 === i && (i = !1);
            var r, s, a = e.getBoundingClientRect(),
                l = n.body,
                c = n.documentElement,
                d = n.defaultView || n.parentWindow,
            ...
            {
                var m = t.offset(o.iframe, o, o.ownerDocument, !0),
                    v = m.top,
                    g = m.left;
        ...
        }, t.normalizeNode = function (e)
        {
            if (e)
            {
                if (e.nodeType === Node.TEXT_NODE && null !== e.nodeValue && e.parentNode)
                    for (; e.nextSibling && e.nextSibling.nodeType === Node.TEXT_NODE;) null !== e.nextSibling.nodeValue && (e.nodeValue += e.nextSibling.nodeValue), e.nodeValue = e.nodeValue.replace(n.INVISIBLE_SPACE_REG_EXP, ""), e.parentNode.removeChild(e.nextSibling);
    ...
    }, function (e, t, o)
    {
        ...
        t.Config = u, t.OptionsDefault = function (e)
        {
            var t = this,
                o = this;
            if (o.plainOptions = e, void 0 !== e && "object" == typeof e)
            {
                var n = function (e, s)
                {
    ...
    }, function (e, t, o)
    {
        ...
        t.Dom = function ()
        {
            ...
            {
                return void 0 === o && (o = /^(img|svg|canvas|input|textarea|form)$/), !t || (t.nodeType === Node.TEXT_NODE ? null === t.nodeValue || 0 === i.trim(t.nodeValue).length : !t.nodeName.toLowerCase().match(o) && e.each(t, function (e)
                {
    ...
    }, function (e, t, o)
    {
        ...
        var u = function (e)
        {
            ...
            }, t.prototype.doOpen = function (e)
            {
                ...
                {
                    var r;
                    if (void 0 !== t.jodit.options.controls[n]) r = new p(t.jodit, i({
                        name: "" + n
                    }, t.jodit.options.controls[n]), t.current);
                    else if (void 0 !== t.jodit.options.controls[o] && "object" == typeof n) r = new p(t.jodit, i({
                        name: "" + o
                    }, t.jodit.options.controls[o], n), t.current);
                    else
                    {
                        r = new p(t.jodit, {
                            name: "" + o,
        ...
        var p = function (e)
        {
            function t(t, o, n)
            {
                ...
                }, i.onMouseDown = function (e)
                {
                    ...
                    } else if (void 0 !== t.exec && "function" == typeof t.exec) t.exec(i.jodit, i.target || !!i.jodit.selection && i.jodit.selection.current(), t, e, i.container), i.jodit.events.fire("synchro"), i.parentToolbar && i.parentToolbar.immedateCheckActiveButtons(), i.jodit.events.fire("closeAllPopups afterExec");
                ...
                if (o.getContent && "function" == typeof o.getContent) l.Dom.detach(i.container), i.container.appendChild(s.dom(o.getContent(i.jodit, o, i), i.jodit.ownerDocument));
                else
                {
                    if (o.list && i.anchor)
                    {
            ...
            function t(t)
            {
                ...
                return o.__buttons = [], o.__getControlType = function (e)
                {
                    ...
                    if ("string" != typeof e) t = i({
                        name: "empty"
                    }, e), void 0 !== o.jodit.options.controls[t.name] && (t = i({}, o.jodit.options.controls[t.name], t));
                    else
                    {
                        var n = e.split(/\./),
                            r = o.jodit.options.controls;
                        n.length > 1 && void 0 !== o.jodit.options.controls[n[0]] && (r = o.jodit.options.controls[n[0]], e = n[1]), t = void 0 !== r[e] ? i({
                            name: e
                        }, r[e]) : {
                                name: e,
                                command: e,
                ...
                }, o.afterOpen = function (e)
                {
                    var t = s.offset(o.jodit.container, o.jodit, o.jodit.ownerDocument, !0),
                        n = s.offset(e, o.jodit, o.jodit.ownerDocument, !0),
                        i = s.css(e, "marginLeft"),
                        r = 0;
                    if (n.left + n.width > t.left + t.width && (r = -(n.left + n.width - (t.left + t.width)), s.css(e, {
                        marginLeft: r + i
                    }), n = s.offset(e, o.jodit, o.jodit.ownerDocument, !0)), t.left > n.left && (n.left + n.width > t.left + t.width ? s.css(e, {
                        width: t.width
                    }) : (r = t.left - n.left, s.css(e, {
                        marginLeft: r + i
                    }))), r)
                    {
    ...
    }, function (e, t, o)
    {
        ...
        t.Jodit = function (e)
        {
            function t(o, n)
            {
                ...
                if (i.version = "3.1.95", i.components = [], i.storage = new m.Storage(new m.localStorageProvider), i.iframe = null, i.__plugins = {}, i.__defaultStyleDisplayKey = "data-jodit-default-style-display", i.__defaultClassesKey = "data-jodit-default-classes", i.isDestructed = !1, i.commands = {}, i.__selectionLocked = null, i.isLockedNotBy = function (e)
                {
            ...
            }, t.prototype.__createEditor = function ()
            {
                ...
                {
                    e.events && e.events.fire(e.element, "change")
                }, this.defaultTimeout))
            }, t.prototype.destruct = function ()
            {
                var e = this;
            ...
            }, t.prototype.i18n = function (e)
            {
                ...
                var r, s = void 0 !== this.options && this.options.debugLanguage,
                    a = function (e)
                    {
    ...
    }, function (e, t, o)
    {
        ...
        t.Plugin = function (e)
        {
            ...
            return n(t, e), t.prototype.beforeDestruct = function (e) { }, t
        }(i.Component)
    }, function (e, t, o)
    {
        "use strict";
        ...
        }, t.Uploader = function ()
        {
            ...
            }, e.prototype.sendFiles = function (e, t, o, n)
            {
                ...
                }), a.length)
                {
                    ...
                    for (var f = void 0, d = 0; a.length > d; d += 1)
                        if ((f = a[d]) && f.type)
                        {
            ...
            }, e.prototype.bind = function (t, o, i)
            {
                var r = this,
                    ...
                    c = function (t)
                    {
                        ...
                        } else if (t.clipboardData && t.clipboardData.items && t.clipboardData.items.length)
                            for (c = 0; t.clipboardData.items.length > c; c += 1)
                                if ("file" === t.clipboardData.items[c].kind && "image/png" === t.clipboardData.items[c].type)
                                {
            ...
            }, e.FileSelectorWidget = function (t, o, r, a, l)
            {
                ...
                if (o.url)
                {
                    var f = i.dom('<form onsubmit="return false;" class="jodit_form"><input type="text" required name="url" placeholder="http://"/><input type="text" name="text" placeholder="' + t.i18n("Alternative text") + '"/><div style="text-align: right"><button>' + t.i18n("Insert") + "</button></div></form>", t.ownerDocument),
                        h = f.querySelector("button"),
                        m = f.querySelector("input[name=url]");
    ...
    }, function (e, t, o)
    {
        ...
        t.EventsNative = function ()
        {
            ...
            }, e.prototype.on = function (e, t, o, n, i)
            {
                ...
                var d = "function" == typeof s.addEventListener,
                    u = this,
                    p = function ()
                    {
                ...
                var l = "function" == typeof i.removeEventListener,
                    ...
                    d = function (e, t)
                    {
                        if ("" !== e)
                        {
                            ...
                            {
                                var i = !1;
                                if ("function" != typeof a) o.forEach(c), o.length = 0, i = !0;
                                else
                                {
            ...
            }, e.prototype.fire = function (e, t)
            {
                ...
                var r, s = void 0,
                    ...
                    d = "function" == typeof a.dispatchEvent;
    ...
    }, function (e, t, o)
    {
        ...
        Object.defineProperty(t, "__esModule", {
            value: !0
        }), t.Component = o(4).Component, t.Ajax = o(14).Ajax, t.ContextMenu = o(15).ContextMenu, t.Cookie = o(60).Cookie;
        var n = o(7);
        ...
        t.Select = function (e)
        {
            function t()
            {
                ...
                }, t.focus = function ()
                {
                    ...
                    if (!t.isFocused())
                    {
                        if (e.options.iframe && s.isIE())
                            for (var o = 0; 1e5 > o && "complete" !== e.editorDocument.readyState;) o++;
                        e.iframe && e.iframe.focus(), e.editorWindow.focus(), e.editor.focus();
                        var n = e.editorWindow.getSelection(),
                            i = e.editorDocument.createRange();
                    ...
                    } else
                    {
                        ...
                        s.normalizeNode(t.jodit.editor.firstChild), t.jodit.editorDocument.execCommand("fontsize", !1, 7), s.$$('font[size="7"]', t.jodit.editor).forEach(function (n)
                        {
                            if (a.Dom.next(n, l, n.parentNode) || a.Dom.prev(n, l, n.parentNode) || !d(n.parentNode) || n.parentNode === t.jodit.editor || a.Dom.isBlock(n.parentNode) && !i.IS_BLOCK.test(o))
                                if (n.firstChild && !a.Dom.next(n.firstChild, l, n) && !a.Dom.prev(n.firstChild, l, n) && d(n.firstChild)) u(n.firstChild);
                                else if (a.Dom.closest(n, d, t.jodit.editor))
                                {
                                    var c = t.jodit.editorDocument.createRange(),
                                        p = a.Dom.closest(n, d, t.jodit.editor);
            ...
            return n(t, e), t.prototype.remove = function ()
            {
                ...
                if (this.current())
                    for (var t = 0; e.rangeCount > t; t += 1) e.getRangeAt(t).deleteContents(), e.getRangeAt(t).collapse(!0)
            ...
            }, t.prototype.save = function ()
            {
                ...
                for (e.removeAllRanges(), t = r - 1; t >= 0; --t)
                {
                    ...
                    if (a)
                        if (i[t].collapsed) s[t].setStartAfter(a), s[t].collapse(!0);
                        else if (s[t].setStartBefore(a), i[t].endId)
                        {
            ...
            }, t.prototype.current = function (e)
            {
                if (void 0 === e && (e = !0), this.jodit.getRealMode() === i.MODE_WYSIWYG && void 0 !== this.jodit.editorWindow.getSelection)
                {
                    ...
                    if (t && t.rangeCount > 0)
                    {
                        ...
                        if (n.nodeType !== Node.TEXT_NODE && (n = o.startContainer.childNodes[o.startOffset], n || (n = o.startContainer.childNodes[o.startOffset - 1], r = !0), n && t.isCollapsed && n.nodeType !== Node.TEXT_NODE))
                            if (!r && n.previousSibling && n.previousSibling.nodeType === Node.TEXT_NODE) n = n.previousSibling;
                            else if (e)
                                for (var l = s(n); l;)
                                {
            ...
            }, t.prototype.cursorInTheEdge = function (e, t)
            {
                ...
                if (!n) return null;
                var i = e ? n.startContainer : n.endContainer,
                    r = function (o)
                    {
                    ...
                    {
                        for (; e;)
                            if ((e = r(e)) && !a.Dom.isEmptyTextNode(e) && "BR" !== e.nodeName) return !1
                    };
    ...
    }, function (e, t, o)
    {
        ...
        t.Snapshot = function (e)
        {
            ...
            }, t.prototype.make = function ()
            {
                ...
                {
                    var n = o.getRangeAt(0),
                        i = this.calcHierarchyLadder(n.startContainer),
                        r = t.strokeOffset(n.startContainer, n.startOffset),
                        s = this.calcHierarchyLadder(n.endContainer),
                        a = t.strokeOffset(n.endContainer, n.endOffset);
    ...
    }, function (e, t, o)
    {
        ...
        t.Table = function ()
        {
            ...
            }, e.formalMatrix = function (e, t)
            {
                for (var o = [
                    []
                ], n = Array.prototype.slice.call(e.rows), i = 0, r = void 0; n.length > i; i += 1)
                {
            ...
            }, e.appendRow = function (t, o, i)
            {
                ...
                var r, s = e.getColumnsCount(t),
                    a = t.ownerDocument.createElement("tr");
            ...
            }, e.appendColumn = function (t, o, n)
            {
                ...
                {
                    var s = t.ownerDocument.createElement("td"),
                        a = r[i][o],
                        l = !1;
            ...
            }, e.getSelectedBound = function (t, o)
            {
                ...
                for (n = 0; a.length > n; n += 1)
                    for (i = 0; a[n].length > i; i += 1) - 1 !== o.indexOf(a[n][i]) && (s[0][0] = Math.min(n, s[0][0]), s[0][1] = Math.min(i, s[0][1]), s[1][0] = Math.max(n, s[1][0]), s[1][1] = Math.max(i, s[1][1]));
            ...
            }, e.normalizeTable = function (t)
            {
                ...
                for (n = 0; a[0].length > n; n += 1)
                {
                    ...
                    if (!r)
                        for (o = 0; a.length > o; o += 1) void 0 !== a[o][n] && e.__mark(a[o][n], "colspan", a[o][n].colSpan - i + 1, s)
                }
                for (o = 0; a.length > o; o += 1)
                {
                    ...
                    if (!r)
                        for (n = 0; a[o].length > n; n += 1) void 0 !== a[o][n] && e.__mark(a[o][n], "rowspan", a[o][n].rowSpan - i + 1, s)
                }
                for (o = 0; a.length > o; o += 1)
                    for (n = 0; a[o].length > n; n += 1) void 0 !== a[o][n] && (a[o][n].hasAttribute("rowspan") && 1 === a[o][n].rowSpan && a[o][n].removeAttribute("rowspan"), a[o][n].hasAttribute("colspan") && 1 === a[o][n].colSpan && a[o][n].removeAttribute("colspan"), a[o][n].hasAttribute("class") && !a[o][n].getAttribute("class") && a[o][n].removeAttribute("class"));
                e.__unmark(s)
            }, e.mergeSelected = function (t)
            {
                var o, r = e.getSelectedBound(t, e.getAllSelectedCells(t)),
                    s = 0,
                    a = null,
                    l = 0,
                    c = [],
    ...
    {
        "use strict";
        this && this.__assign || Object, o(22), o(23);
        var n = o(6),
            i = o(5),
            r = o(2),
            s = o(29),
        ...
        (function (t)
        {
            ! function (t, o)
            {
                e.exports = function ()
                {
                    ...
                    function y(e, t)
                    {
                        e._state === $ && (e._result = t, e._state = J, 0 !== e._subscribers.length && H(E, e))
                    }

                    function w(e, t)
                    {
                        e._state === $ && (e._state = Z, e._result = t, H(b, e))
                    }
                    ...
                    function x(e, t, n, i)
                    {
                        ...
                        t._state !== $ || (r && l ? _(t, s) : c ? w(t, a) : e === J ? y(t, s) : e === Z && w(t, s))
                    }
                    ...
                    var G = Math.random().toString(36).substring(2),
                        ...
                        te = function ()
                        {
                            function e(e, t)
                            {
                                this._instanceConstructor = e, this.promise = new e(d), this.promise[G] || q(this.promise), z(t) ? (this.length = t.length, this._remaining = t.length, this._result = Array(this.length), 0 === this.length ? y(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(t), 0 === this._remaining && y(this.promise, this._result))) : w(this.promise, D())
                            }
                            return e.prototype._enumerate = function (e)
                            {
                                for (var t = 0; this._state === $ && e.length > t; t++) this._eachEntry(e[t], t)
                            }, e.prototype._eachEntry = function (e, t)
                            {
                                ...
                                {
                                    var i = f(e);
                                    if (i === l && e._state !== $) this._settledAt(e._state, t, e._result);
                            ...
                            {
                                var n = this.promise;
                                n._state === $ && (this._remaining-- , e === Z ? w(n, o) : this._result[t] = o), 0 === this._remaining && y(n, this._result)
                        ...
                        oe = function ()
                        {
                            function e(t)
                            {
                                this[G] = S(), this._result = this._state = void 0, this._subscribers = [], d !== t && ("function" != typeof t && A(), this instanceof e ? T(this, t) : k())
                            }
                    ...
                    return oe.prototype.then = l, oe.all = N, oe.race = L, oe.resolve = c, oe.reject = I, oe._setScheduler = n, oe._setAsap = i, oe._asap = H, oe.polyfill = M, oe.Promise = oe, oe
                }()
            }()
        }).call(t, o(27))
    }, function (e, t)
    ...
    }, function (e, t, o)
    {
        ...
        function n(e)
        {
            ...
            {
                var t, o, n = r.dom('<div role="button" tabIndex="-1" title="' + e.i18n("Break") + '" class="jodit-add-new-line"><span>' + s.ToolbarIcon.getIcon("enter") + "</span></div>", e.ownerDocument),
                    i = RegExp("^(" + e.options.addNewLineTagsTriggers.join("|") + ")$", "i"),
                    l = !1,
                    c = !1,
                    d = !1,
                    u = function ()
                ...
                }).on("afterInit", function ()
                {
                    ...
                    }).on(e.editor, "dblclick", function (t)
                    {
                        ...
                        {
                            var o = r.offset(e.editor, e, e.editorDocument),
                                n = t.pageY - e.editorWindow.pageYOffset,
                    ...
                    }).on(e.editor, "mousemove", r.debounce(function (t)
                    {
                        ...
                        if ((!s || !a.Dom.isOrContains(n, s)) && s && a.Dom.isOrContains(e.editor, s))
                        {
                            ...
                            var d = r.offset(e.editor, e, e.editorDocument),
                                p = r.offset(s, e, e.editorDocument),
                                m = !1;
    ...
    }, function (e, t, o)
    {
        ...
        function n(e)
        {
            var t = function (t)
            {
                ...
                n = /^(IMG|BR|IFRAME|SCRIPT|INPUT|TEXTAREA|HR)$/,
                a = function (e)
                {
                    if (e && n.test(e.nodeName)) return e.parentNode && e.parentNode.removeChild(e), !1
                },
                l = function (t, n, i)
                {
                    if (t.node)
                    {
                        var r = t.node;
                        if (void 0 !== o(t, n, i)) return !0;
                        if (t.node || (t.node = r.parentNode), t.node === e.editor) return !1;
                        var s = t.node;
                        if (!1 === a(s)) return !1;
                        for (s && (s = n ? s.previousSibling : s.nextSibling); s && s.nodeType === Node.TEXT_NODE && s.nodeValue && s.nodeValue.match(/^[\n\r]+$/);) s = n ? s.previousSibling : s.nextSibling;
                        return a(s)
                    }
                },
                c = function (e)
                {
                    return null === e.nodeName.match(/^(TD|TH|TR|TABLE|LI)$/) && (!(!s.Dom.isEmpty(e) && null === e.nodeName.match(n)) || !(e.nodeType === Node.TEXT_NODE && !s.Dom.isEmptyTextNode(e)) && (!e.childNodes.length || [].slice.call(e.childNodes).every(c)))
                };
            ...
            {
                if (o.which === i.KEY_BACKSPACE || o.which === i.KEY_DELETE)
                {
                    var n = o.which === i.KEY_BACKSPACE;
                    if (e.selection.isFocused() || e.selection.focus(), !e.selection.isCollapsed()) return e.execCommand("Delete"), !1;
                    var a = e.editorWindow.getSelection(),
                        d = !!a.rangeCount && a.getRangeAt(0);
                    if (!d) return !1;
                    var u = e.ownerDocument.createTextNode(i.INVISIBLE_SPACE),
                        p = e.editorDocument.createElement("span");
                    try
                    {
                        if (d.insertNode(u), !s.Dom.isOrContains(e.editor, u)) return !1;
                        var f = s.Dom.up(u, s.Dom.isBlock, e.editor),
                            h = s.Dom.findInline(u, n, e.editor),
                            m = {
                                node: h
                            },
                            v = void 0;
                        if (h ? v = l(m, n, d) : u.parentNode && (v = l({
                            node: n ? u.parentNode.previousSibling : u.parentNode.nextSibling
                        }, n, d)), void 0 !== v) return !!v && void 0;
                        if (f && f.nodeName.match(/^(TD)$/)) return !1;
                        var g = n ? s.Dom.prev(m.node || u, s.Dom.isBlock, e.editor) : s.Dom.next(m.node || u, s.Dom.isBlock, e.editor);
                        if (!g && f && f.parentNode)
                        {
                            g = e.editorDocument.createElement(e.options.enter);
                            for (var _ = f; _ && _.parentNode && _.parentNode !== e.editor;) _ = _.parentNode;
                            _.parentNode && _.parentNode.insertBefore(g, _)
                        } else if (g && c(g)) return g.parentNode && g.parentNode.removeChild(g), !1;
                        if (g)
                        {
                            var b = e.selection.setCursorIn(g, !n);
                            e.selection.insertNode(p, !1, !1), b.nodeType === Node.TEXT_NODE && b.nodeValue === i.INVISIBLE_SPACE && b.parentNode && b.parentNode.removeChild(b)
                        }
                        if (f)
                        {
                            if (t(f), g && f.parentNode && (f.nodeName === g.nodeName && f.parentNode && g.parentNode && f.parentNode !== e.editor && g.parentNode !== e.editor && f.parentNode !== g.parentNode && f.parentNode.nodeName === g.parentNode.nodeName && (f = f.parentNode, g = g.parentNode), s.Dom.moveContent(f, g, !n), r.normalizeNode(g)), g && "LI" === g.nodeName)
                            {
                                var y = s.Dom.closest(g, "Ul|OL", e.editor);
                                if (y)
                                {
                                    var w = y.nextSibling;
                                    w && w.nodeName === y.nodeName && y !== w && (s.Dom.moveContent(w, y, !n), w.parentNode && w.parentNode.removeChild(w))
                                }
                            }
                            return t(f), !1
                        }
                    ...
                    {
                        if (u.parentNode && u.nodeValue === i.INVISIBLE_SPACE && u.parentNode.removeChild(u), p && s.Dom.isOrContains(e.editor, p, !0))
                        {
                            var b = e.selection.setCursorBefore(p);
                            p.parentNode && p.parentNode.removeChild(p), b && b.parentNode && (s.Dom.findInline(b, !0, b.parentNode) || s.Dom.findInline(b, !0, b.parentNode)) && b.parentNode.removeChild(b)
                        }
                        e.setEditorValue()
                    }
                    return !1
    ...
    }, function (e, t, o)
    {
        ...
        function n(e)
        {
            var t = function (t)
            {
                var o = r.Jodit.defaultOptions.controls[t],
                    n = i({}, o.css),
                    s = {};
            ...
            e.registerCommand("bold", {
                exec: t,
                hotkeys: "ctrl+b"
            }), e.registerCommand("italic", {
                exec: t,
                hotkeys: "ctrl+i"
            }), e.registerCommand("underline", {
                exec: t,
                hotkeys: "ctrl+u"
            }), e.registerCommand("strikethrough", {
                exec: t
            })
        }
    ...
    }, function (e, t, o)
    {
        ...
        function n(e)
        {
            ...
            var t, o = /([^\[]*)\[([^\]]+)]/,
                ...
                d = c(e.options.cleanHTML.allowTags),
                u = c(e.options.cleanHTML.denyTags),
                p = function (e, t)
                {
                    void 0 === t && (t = !1);
            ...
            e.events.on("change afterSetMode afterInit mousedown keydown", s.debounce(function ()
            {
                if (!e.isDestructed && e.isEditorMode())
                {
                    ...
                    var o = null,
                        ...
                        i = !1,
                        r = 0,
                        s = e.options.cleanHTML.replaceOldTags;
                    if (s && t)
                    {
                        ...
                        if (e.selection.isCollapsed())
                        {
                            ...
                            if (c)
                            {
                                var u = e.selection.save(),
                                    p = s[c.nodeName.toLowerCase()] || s[c.nodeName];
                    ...
                    var h = function (t)
                    {
                        if (t)
                        {
                            if (f(t)) return n.push(t), h(t.nextSibling);
                            if (e.options.cleanHTML.fillEmptyParagraph && a.Dom.isBlock(t) && a.Dom.isEmpty(t, /^(img|svg|canvas|input|textarea|form|br)$/))
                            {
                                var o = e.editorDocument.createElement("br");
                                t.appendChild(o)
                            }
                            if (d && !0 !== d[t.nodeName] && t.attributes && t.attributes.length)
                            {
                                var s = [];
                                for (r = 0; t.attributes.length > r; r += 1)(!d[t.nodeName][t.attributes[r].name] || !0 !== d[t.nodeName][t.attributes[r].name] && d[t.nodeName][t.attributes[r].name] !== t.attributes[r].value) && s.push(t.attributes[r].name);
                                s.length && (i = !0), s.forEach(function (e)
                                {
                                    t.removeAttribute(e)
                                })
                            }
                            h(t.firstChild), h(t.nextSibling)
                        }
                    };
            ...
            }).on("afterCommand", function (t)
            {
                ...
                switch (t.toLowerCase())
                {
                    ...
                    case "removeformat":
                        ...
                        if (i.isCollapsed())
                            for (; n && n.nodeType !== Node.ELEMENT_NODE && n !== e.editor;) l(n), n && (n = n.parentNode);
        ...
        r.Config.prototype.controls.brush = {
            isActive: function (e, t, o)
            {
                var n = e.selection.current(),
                    r = o.container.querySelector("svg");
                if (n)
                {
            ...
            popup: function (e, t, o, n)
            {
                ...
                return r = "background" === e.options.colorPickerDefaultTab ? {
                    Background: p,
                    Text: f
                } : {
                        Text: f,
    ...
    }, function (e, t, o)
    {
        ...
        n.Config.prototype.controls.copyformat = {
            ...
            {
                if (t)
                    if (e.buffer.copyformat) e.buffer.copyformat = !1, e.events.off(e.editor, "mouseup.copyformat");
                    else
                    {
                        var o = {},
                            n = i.Dom.up(t, function (e)
                            {
                                return e && e.nodeType !== Node.TEXT_NODE
                            }, e.editor) || e.editor,
                            a = e.editorDocument.createElement("span");
    ...
    }, function (e, t, o)
    {
        ...
        function n(e)
        {
            e.events.on("keydown", function (o)
            {
                if (o.which === r.KEY_ENTER)
                {
                    ...
                    var a = e.selection.current(!1),
                        l = e.editorWindow.getSelection(),
                    ...
                    if (d)
                    {
                        ...
                        {
                            var g = !1,
                                _ = s.Dom.closest(d, "ol|ul", e.editor);
                            if (s.Dom.prev(d, function (e)
                            {
                                ...
                                } else g = e.selection.setCursorAfter(_);
                            else g = e.selection.setCursorBefore(_);
        ...
        t.insertParagraph = function (e, t, o, n)
        {
            ...
            var r = e.editorDocument.createElement(o),
                s = e.editorDocument.createElement("br");
    ...
    }, function (e, t, o)
    {
        ...
        function n(e)
        {
            ...
            {
                var t, o = r.dom('<div class="jodit_error_box_for_messages"></div>', e.ownerDocument),
                    n = function ()
                    {
            ...
            e.registerCommand("formatblock", function (t, o, n)
            {
                ...
                if (e.selection.eachSelection(function (t)
                {
                    var o = e.selection.save(),
                        r = !!t && i.Dom.up(t, i.Dom.isBlock, e.editor);
    ...
    }, function (e, t, o)
    {
        ...
        i.Config.prototype.fullsize = !1, i.Config.prototype.globalFullsize = !0, i.Config.prototype.controls.fullsize = {
            ...
            mode: a.MODE_SOURCE + a.MODE_WYSIWYG
        }, t.fullsize = n
    }, function (e, t, o)
    {
        "use strict";
            ...
            var t = function (t)
            {
                return e.selection.eachSelection(function (o)
                {
                    var n = e.selection.save(),
                        i = !!o && r.Dom.up(o, r.Dom.isBlock, e.editor);
    ...
    }, function (e, t, o)
    {
        ...
        var i = o(0),
            r = "__jodit_imageprocessor_binded";
        t.imageProcessor = n
    }, function (e, t, o)
    {
        "use strict";
            ...
            var t = function (t)
            {
                ...
                if (!e.options.readonly)
                {
                    ...
                    var n, r = this,
                        ...
                        m = {
                            remove: s.dom('<a href="javascript:void(0)" class="jodit_button">' + l.ToolbarIcon.getIcon("bin") + " " + e.i18n("Delete") + "</a>", e.ownerDocument)
                        },
                        ...
                        b = r.naturalWidth / r.naturalHeight || 1,
                        y = v.querySelector(".imageWidth"),
                        w = v.querySelector(".imageHeight"),
                        C = function ()
                        {
                        ...
                        A = !0,
                        k = {},
                        M = v.querySelector(".tabsbox");
                    k[e.i18n("Image")] = _, k[e.i18n("Advanced")] = g, M && M.appendChild(u(e, k)), L(), e.events.on(d, "afterClose", function ()
                    {
                        ...
                        e.events.on(t, "mousedown touchstart", function ()
                        {
                                ...
                                n = function ()
                                {
                                    if (o.host !== location.host) return void a.Confirm(e.i18n("You can only edit your own images. Download this image on the host?"), function (t)
                                    {
                                        t && e.uploader && e.uploader.uploadRemoteImage("" + o.href, function (t)
                                        {
                                            ...
                                            {
                                                "string" == typeof t.newfilename && (r.setAttribute("src", t.baseurl + t.newfilename), N())
                                            })
                                        }, function (t)
                                            {
                            ...
                            o.href = t, e.getInstance("FileBrowser").getPathByUrl("" + o.href, function (n, i, s)
                            {
                                e.getInstance("FileBrowser").openImageEditor(o.href, i, n, s, function ()
                                {
                                    ...
                                    r.setAttribute("src", t + (-1 !== t.indexOf("?") ? "" : "?") + "&_tmp=" + e), N()
                                }, function (e)
                                    {
                                        a.Alert(e.message)
                                    })
                    ...
                    }), s.$$(".jodit_rechange", _).forEach(function (t)
                    {
                        t.addEventListener("mousedown", function (o)
                        {
                            ...
                            n.open(p(e, {
                                upload: function (e)
                                {
                                    e.files && e.files.length && r.setAttribute("src", e.baseurl + e.files[0]), L(), n.close()
                                },
                                filebrowser: function (e)
                                {
                                    e && e.files && Array.isArray(e.files) && e.files.length && (r.setAttribute("src", e.files[0]), n.close(), L())
                                }
                    ...
                    {
                        I = !I, this.innerHTML = l.ToolbarIcon.getIcon(I ? "lock" : "unlock"), e.events.fire(y, "change")
                    ...
                    var P = function (e)
                    {
                        var t = parseInt(y.value, 10),
                            o = parseInt(w.value, 10);
                        e.target === y ? w.value = "" + Math.round(t / b) : y.value = "" + Math.round(o * b)
                    };
                    return e.events.on([y, w], "change keydown mousedown paste", function (t)
                    {
                        I && (e.defaultTimeout ? (clearTimeout(n), n = window.setTimeout(P.bind(o, t), e.defaultTimeout)) : P(t))
    ...
    }, function (e, t, o)
    {
            ...
            img: [{
                ...
                exec: function (e, t, o)
                {
                    if ("img" === t.tagName.toLowerCase())
                    {
                        ...
                        s.css(t, "vertical-align", n), e.events.fire("recalcPositionPopup")
                    }
                }
            }, {
                name: "left",
                ...
                exec: function (e, t, o)
                {
                    if ("img" === t.tagName.toLowerCase())
                    {
                        ...
                        "normal" !== i ? -1 !== ["right", "left"].indexOf(i) ? (s.css(t, "float", i), n()) : (s.css(t, "float", ""), s.css(t, {
                            ...
                            "margin-left": "auto",
                            "margin-right": "auto"
                        })) : (s.css(t, "float") && -1 !== ["right", "left"].indexOf(s.css(t, "float").toLowerCase()) && s.css(t, "float", ""), n()), e.events.fire("recalcPositionPopup")
                    }
                },
        ...
        }, t.inlinePopup = function (e)
        {
            function t(t)
            {
                ...
                {
                    var e = o.jodit.ownerWindow,
                        t = o.jodit.ownerDocument.documentElement,
                        n = o.jodit.ownerDocument.body,
                        i = e.pageYOffset || t.scrollTop || n.scrollTop,
                        r = t.clientTop || n.clientTop || 0,
                        s = e.pageXOffset || t.scrollLeft || n.scrollLeft,
                        a = t.clientLeft || n.clientLeft || 0;
                    return {
                        left: a,
                        top: r,
                        width: t.clientWidth + s - a,
                        height: t.clientHeight + i - r
                    }
                }, o._hiddenClass = "jodit_toolbar_popup-inline-target-hidden", o.calcPosition = function (e, t)
                {
                    o.popup.target.classList.remove(o._hiddenClass);
                    var n = e.left + e.width / 2,
                        i = s.offset(o.jodit.workplace, o.jodit, o.jodit.ownerDocument, !0),
                        r = e.top + e.height + 10;
                    o.target.style.left = n + "px", o.target.style.top = r + "px", o.jodit.isFullSize() && (o.target.style.zIndex = "" + s.css(o.jodit.container, "zIndex"));
                    var a = o.container.offsetWidth / 2,
                        l = -a;
                ...
                }, o.reCalcPosition = function ()
                {
                    o.__getRect && o.calcPosition(o.__getRect(), o.calcWindSizes())
                }, o.showPopup = function (e, t, n)
                {
                    ...
                    return o.target.parentNode || o.jodit.ownerDocument.body.appendChild(o.target), o.toolbar.build(o.jodit.options.popup[t.toLowerCase()], o.container, n), o.popup.open(o.container, !1, !0), o.__getRect = e, o.calcPosition(e(), i), !0
            ...
            }, t.prototype.afterInit = function (e)
            {
                ...
                {
                    e.stopPropagation()
                }).on("beforeOpenPopup hidePopup", this.hidePopup).on("recalcPositionPopup", this.reCalcPosition).on("getDiffButtons.mobile", function (o)
                {
                ...
                }).on("mousedown keydown touchstart", this.onSelectionStart).on([e.ownerWindow, e.editor], "scroll resize", this.reCalcPosition).on([e.ownerWindow], "mouseup keyup touchend", this.onSelectionEnd).on([e.ownerWindow], "mousedown keydown touchstart", this.checkIsTargetEvent)
    ...
    }, function (e, t, o)
    {
        ...
        function n(e)
        {
            ...
            }), e.options.link.processPastedLink && e.events.on("processPaste", function (t, o)
            {
                if (r.isURL(o))
                {
                    ...
                    return i.setAttribute("href", o), i.innerText = o, e.options.link.openLinkDialogAfterPost && setTimeout(function () { }, 100), i
                }
        ...
        i.Config.prototype.link = {
            ...
            popup: function (e, t, o, n)
            {
                ...
                var l = a.querySelector(".jodit_link_insert_button"),
                    c = a.querySelector(".jodit_unlink_button");
    ...
    }, function (e, t, o)
    {
        ...
        {
            var t, o = 0,
                n = a.splitArray(e.options.buttons);
    ...
    }, function (e, t, o)
    {
        ...
        function n(e)
        {
            ...
            {
                var i = e.selection.getHTML(),
                    r = d(n) || d(e.editorWindow) || d(n.originalEvent);
            ...
            }).on("paste", function (o)
            {
                ...
                if (o && d(o))
                {
                    var n = void 0,
                        ...
                        l = "",
                        u = "";
                    if (Array.isArray(i) || "domstringlist" === r.type(i))
                        for (n = 0; i.length > n; n += 1) l += i[n] + ";";
                    else l = i;
            ...
            if (e.options.showPlaceholder)
            {
                ...
                var t = function ()
                {
                    if (i.parentNode && !e.options.readonly)
                    {
                        var t = 0,
                            o = 0,
                            n = e.editorWindow.getComputedStyle(e.editor);
    ...
    }, function (e, t, o)
    {
        ...
        function n(e)
        {
            var t, o, n, i, a, l, c, d, u, p, f, h = !1,
                ...
                b = _.getElementsByTagName("span")[0],
                y = function ()
                {
                ...
                C = function ()
                {
                    if (v && o && _)
                    {
                        var t = s.offset(_.parentNode || e.ownerDocument.documentElement, e, e.ownerDocument, !0),
                            n = s.offset(o, e, e.editorDocument),
                            i = parseInt(_.style.left || "0", 10),
                            r = parseInt(_.style.top || "0", 10),
                            a = _.offsetWidth,
                            l = _.offsetHeight,
                            c = n.top - 1 - t.top,
                            d = n.left - 1 - t.left;
                        r === c && i === d && a === o.offsetWidth && l === o.offsetHeight || (_.style.top = c + "px", _.style.left = d + "px", _.style.width = o.offsetWidth + "px", _.style.height = o.offsetHeight + "px", e.events && (e.events.fire(o, "changesize"), isNaN(i) || e.events.fire("resize")))
                    }
                },
                E = function ()
                {
                    e.options.readonly || (_.parentNode || e.workplace.appendChild(_), v = !0, _.style.display = "block", e.isFullSize() && (_.style.zIndex = "" + s.css(e.container, "zIndex")), C())
                },
                j = function (t)
                {
                    var n;
                    if ("IFRAME" === t.tagName)
                        if (t.parentNode && t.parentNode.getAttribute("data-jodit_iframe_wrapper")) t = t.parentNode;
                        else
                        {
            ...
            {
                v && (o && o.parentNode ? C() : y()), e.isDestructed || s.$$("img, table, iframe", e.editor).forEach(function (t)
                {
    ...
    }, function (e, t, o)
    {
        ...
        function n(e)
        {
            ...
            var l = function ()
            {
                ...
                d = function ()
                {
                    e.options.inline || (c(), e.container && ("auto" !== e.options.height || e.isFullSize()) && n(e.container.offsetHeight - l()))
                },
            ...
            {
                e.options.inline || (i.css(e.editor, {
                    minHeight: "100%"
                }), i.css(e.container, {
                ...
                e.options.inline || (t(n), o(e.options.width)), d()
    ...
    }, function (e, t, o)
    {
        ...
        }, i.Config.prototype.sourceEditorCDNUrlsJS = ["js/ace-1_3_3/ace.js"], i.Config.prototype.beautifyHTMLCDNUrlsJS = ["js/jodit-3_1_95/beautify.min.js", "js/jodit-3_1_95/beautify-html.min.js"], i.Config.prototype.controls.source = {
            mode: r.MODE_SPLIT,
            exec: function (e)
            {
                e.toggleMode()
        ...
        }, t.source = function (e)
        {
            function t(t)
            {
                ...
                }, o.insertHTML = function (e)
                {
                    ...
                    {
                        var t = o.mirror.selectionStart,
                            n = o.mirror.selectionEnd;
                ...
                {
                    if (o.jodit.getRealMode() === r.MODE_WYSIWYG) o.selInfo = o.jodit.selection.save() || [], o.jodit.setEditorValue(), o.fromWYSIWYG(!0);
                    else
                    {
                        o.selInfo.length = 0;
            ...
            }, t.prototype.replaceMirrorToACE = function ()
            {
                var e, t, o = this,
                    ...
                    d = function (t, o)
                    {
                        var n = c(t),
                            i = c(o);
                        e.getSelection().setSelectionRange({
                            start: n,
                            end: i
                        })
                    },
                    ...
                    p = function ()
                    {
                        if (void 0 === e && void 0 !== o.jodit.ownerWindow.ace)
                        {
                            ...
                            {
                                var o = e.selection.getCursor(),
                                    n = e.session.insert(o, t);
    ...
    }, function (e, t, o)
    {
        ...
        s.Config.prototype.useTableProcessor = !0, s.Config.prototype.useExtraClassesOptions = !0, s.Config.prototype.controls.table = {
            ...
            popup: function (e, t, o, n, i)
            {
                var s, l, c, d, u = 1,
                    p = 1,
                    f = o.data && o.data.rows ? o.data.rows : 10,
                    ...
                    m = r.dom('<form class="jodit_form jodit_form_inserter"><label><span>1</span> &times; <span>1</span></label><div class="jodit_form-table-creator-box"><div class="jodit_form-container"></div><div class="jodit_form-options">' + function ()
                    {
                        ...
                        return t.join("")
                    }() + "</div></div></form>", e.ownerDocument),
                    v = m.querySelectorAll("span")[0],
                    g = m.querySelectorAll("span")[1],
                    _ = m.querySelector(".jodit_form-container"),
                    b = m.querySelector(".jodit_form-table-creator-box"),
                    y = m.querySelector(".jodit_form-options"),
                    w = [],
                    C = function (t)
                    {
                        var o = t * h;
                ...
                return n.__key = "table_processor_observer", n.__selectMode = !1, n.__resizerDelta = 0, n.__drag = !1, n.__addResizer = function ()
                {
                    if (!n.__resizerHandler && !(n.__resizerHandler = n.jodit.container.querySelector(".jodit_table_resizer")))
                    {
                        ...
                        n.jodit.events.on(n.__resizerHandler, "mousedown touchstart", function (t)
                        {
                            ...
                            if (n.__minX = 0, n.__maxX = 1e6, null !== n.__wholeTable) r = n.__workTable.parentNode.getBoundingClientRect(), n.__minX = r.left, n.__maxX = r.left + r.width;
                            else
                            {
                ...
                }, o.options.useTableProcessor ? (o.events.on(n.jodit.ownerWindow, "mouseup touchend", function ()
                {
                    if ((n.__selectMode || n.__drag) && (n.__selectMode = !1, n.jodit.unlock()), n.__resizerHandler && n.__drag)
                    {
                        ...
                        } else
                        {
                            ...
                            if (!1 === n.__wholeTable) n.__workTable.style.width = (s + n.__resizerDelta) / l * 100 + "%";
                            else
                            {
            ...
            }, t.prototype.__calcResizerPosition = function (e, o, n, s)
            {
                ...
                else
                {
                    ...
                    if (this.__resizerHandler.style.left = (n > i.NEARBY ? l.left + l.width : l.left) + s + "px",
                        ...
                        this.__resizerHandler.style.display = "block", n > i.NEARBY)
                    ...
                    if (!o.jodit.options.readonly && !o.__drag && !o.jodit.isLockedNotBy(o.__key))
                    {
                        ...
                        if (s)
                            if (o.__selectMode)
                            {
                                ...
                                for (var l = a.Table.getSelectedBound(e, [s, n]), c = a.Table.formalMatrix(e), d = l[0][0]; l[1][0] >= d; d += 1)
                                    for (var u = l[0][1]; l[1][1] >= u; u += 1) a.Table.addSelected(c[d][u]);
                                var p = c[l[1][0]][l[1][1]],
                                    f = c[l[0][0]][l[0][1]];
    ...
    }, function (e, t, o)
    {
        ...
        var g = "default",
            _ = "jodit_filebrowser_files_item";
        t.FileBrowser = function (e)
        {
            function t(t, o)
            {
                ...
                }, n.openImageEditor = function (e, t, o, i, r, s)
                {
                    ...
                    {
                        void 0 === n.options[a.action] && (n.options[a.action] = {}), void 0 === n.options[a.action].data && (n.options[a.action].data = {
                            action: a.action
                        }), n.options[a.action].data.newname = e || t, n.options[a.action].data.box = a.box, n.options[a.action].data.path = o, n.options[a.action].data.name = t, n.options[a.action].data.source = i, n.send(a.action, function (e)
                        {
                ...
                var s = n,
                    f = t ? t.ownerDocument : document,
                    b = t ? t.editorDocument : f;
            ...
            e.events.on("keydown", function (t)
            {
                ...
                }, e.editor)))
                {
                    ...
                    }, n) || t.which !== i.KEY_DOWN && o.nodeType === Node.TEXT_NODE && o.nodeValue && a.startOffset !== o.nodeValue.length)))
                    {
                        ...
                        if (c)
                        {
                            if (c.firstChild) t.which === i.KEY_TAB ? e.selection.select(c, !0) : e.selection.setCursorIn(c, t.which === i.KEY_RIGHT || t.which === i.KEY_DOWN);
                            else
                            {
    ...
    }, function (e, t, o)
    {
        ...
        i.Config.prototype.useSearch = !0, t.search = function (e)
        {
            function t(o)
            {
                ...
                {
                    void 0 === t && (t = !1);
                    for (var o = 0, i = 0, r = [], s = !1, a = n.jodit.editor.firstChild; a && e.length;)
                    ...
                    if (e && o.length)
                    {
                        ...
                        if (n.eachMap(e, function (e)
                        {
                            if (e.nodeType === Node.TEXT_NODE && null !== e.nodeValue && e.nodeValue.length)
                            {
                                ...
                                var u = i ? c + n : n + c,
                                    p = t.findSomePartOfString(o, u, i);
                                if (!1 !== p)
                                {
    ...
    }, function (e, t, o)
    {
        ...
        }, r.Config.prototype.showXPathInStatusbar = !0, t.xpath = function (e)
        {
            function t()
            {
                ...
                {
                    var e = new c.ToolbarButton(t.jodit, i({
                        name: "selectall"
                    }, t.jodit.options.controls.selectall, {
                            tooltip: ""
                        }));
                    t.container.insertBefore(e.container, t.container.firstChild)
                }, t.calcPathImd = function ()
                {
                    var e = t.jodit.selection.current(),
                        o = 0;
        ...
        t.DragAndDrop = function (e)
        {
            function t()
            {
                ...
                }, 10), t.bufferRange = null, t.onDragStart = function (e)
                {
                    ...
                    {
                        var n = t.jodit.editorWindow.getSelection(),
                            i = n.rangeCount ? n.getRangeAt(0) : null;
                ...
                }, t.onDrop = function (e)
                {
                    if (!e.dataTransfer.files || !e.dataTransfer.files.length)
                    {
                        ...
                        var o = t.jodit.editorWindow.getSelection(),
                            n = t.bufferRange || (o.rangeCount ? o.getRangeAt(0) : null),
                            i = null;
                        if (!t.draggable && n) i = t.isCopyMode ? n.cloneContents() : n.extractContents();
                        else if (t.draggable)
                            if (t.isCopyMode)
                            {
                            ...
                            } else i = r.dataBind(t.draggable, "target");
                        else t.getText(e) && (i = r.dom(t.getText(e), t.jodit.editorDocument));
    ...
    }, function (e, t, o)
    {
        ...
        Object.defineProperty(t, "__esModule", {
            value: !0
        }), t.de = o(71).default, t.en = o(72).default, t.fr = o(73).default, t.ru = o(74).default, t.ar = o(75).default
    }, function (e, t, o)
    {
        "use strict";
        Object.defineProperty(t, "__esModule", {
